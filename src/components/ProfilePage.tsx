...
const ProfilePage: React.FC<ProfileProps> = ({ 
  ...
  return (
    <Container sx={{ padding: '2em', backgroundColor: '#f8f9fa', borderRadius: '10px' }}>
      <Grid container spacing={3} alignItems="center">
        <Grid item xs={12} sm={4}>
          <Avatar src={profilePhoto} alt={`${firstName} ${lastName}`} sx={{ width: 150, height: 150, marginLeft: 'auto', marginRight: 'auto', display: 'block' }} />
        </Grid>
        <Grid item xs={12}>
